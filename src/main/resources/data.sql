...
INSERT INTO Users (username, email, password, enabled, roles, ACCOUNT_NON_EXPIRED, ACCOUNT_NOT_LOCKED, CREDENTIALS_NON_EXPIRED, IS_ONLINE) VALUES ('user2', 'user2@gmai.com', 'pass', true, 'ROLE_USER', true, true, true, true);
